...
while ! mysqladmin ping -u root -h mysql-5.5-source; do
  sleep 1;
done

mysql -u root -h mysql-5.5-source -e "FLUSH TABLES WITH READ LOCK; SHOW MASTER STATUS\\G" > \
